            ...
            try {
                ...
                function getCategorizedItems() {
                    ...
                    const ranges = {
                        ...
                        'SNIPER_MARKSMAN': [22, 38],      // Indices 22-37: Sniper & marksman rifles (16 items)
                        'RIFLES_SHOTGUNS': [38, 46],      // Indices 38-45: Rifles & shotguns (8 items)
                        'PISTOLS': [46, 60],              // Indices 46-59: Pistols (14 items)
                        'MELEE': [60, 80],                // Indices 60-79: Melee weapons (20 items)
                        'ATTACHMENTS': [80, 164],         // Indices 80-163: Attachments (84 items)
                        'AMMUNITION': [164, 182],         // Indices 164-181: Ammunition (18 items)
                        'MEDICAL': [182, 199],            // Indices 182-198: Medical supplies (17 items)
                        'FOOD_DRINK': [199, 226],         // Indices 199-225: Food & drink (27 items)
                        'TOOLS': [226, 238],              // Indices 226-237: Tools & repair (12 items)
                        'CLOTHING_ARMOR': [238, 328],     // Indices 238-327: Clothing & armor (90 items)
                        'BACKPACKS': [328, 354],          // Indices 328-353: Backpacks & storage (26 items)
                        'BUILDING': [354, 365],           // Indices 354-364: Building materials (11 items)
                        'VEHICLE': [365, 377],            // Indices 365-376: Vehicle parts (12 items)
                        'ELECTRONICS': [377, 401]         // Indices 377-400: Electronics & explosives (24 items, total 401)
                    };
