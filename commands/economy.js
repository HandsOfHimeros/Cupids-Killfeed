            ...
            try {
                ...
                function getCategorizedItems() {
                    ...
                    const ranges = {
                        ...
                        'ATTACHMENTS': [82, 164],         // Indices 82-163: Attachments (82 items, ends with CMAG 40rnd)
                        'AMMUNITION': [164, 185],         // Indices 164-184: Ammunition (21 items, starts with Ammo Box .308)
                        ...
                        'CLOTHING_ARMOR': [241, 328],     // Indices 241-327: Clothing & armor (87 items, ends with Ghillie Bushrag)
                        'BACKPACKS': [328, 357],          // Indices 328-356: Backpacks & storage (29 items, starts with Alice Bag)
