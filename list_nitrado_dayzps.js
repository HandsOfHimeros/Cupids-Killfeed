// Script to list files in the '/games/17292046/noftp/dayzps/' folder using the Nitrado API (using numeric ID)
// Run with: node list_nitrado_dayzps.js
...
const DIRECTORY = '/games/17292046/noftp/dayzps';
...
(async () => {
  try {
    ...
    if (!files.length) {
      console.log('No files found in dayzps folder.');
      return;
    }
    console.log('Files in dayzps folder:');
