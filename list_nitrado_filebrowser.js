// Script to list files in the '/games/17292046/noftp/dayzps/filebrowser' folder using the Nitrado API
// Run with: node list_nitrado_filebrowser.js
...
const DIRECTORY = '/games/17292046/noftp/dayzps/filebrowser';
...
(async () => {
  try {
    ...
    if (!files.length) {
      console.log('No files found in filebrowser folder.');
      return;
    }
    console.log('Files in filebrowser folder:');
